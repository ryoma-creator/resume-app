  ...
  return (
    <ResumeContainer>
      ...
      <Page className="page">
        ...
        <SectionContent>
          明治学院大学法学部法律学科卒業後、教育・販売・空港業務等の多角的な実務経験とIT・語学スキル習得を通じて、2022年にアクセンチュア株式会社に入社。日本・フィリピン両拠点での約2年間にわたり、金融・HR業務システムの国際実装プロジェクトを担当。フィリピン3年居住経験により現地適応力を習得し、多国籍チーム調整のスペシャリストとして活躍。最終半年間にサブチームリーダーへ抜擢され、新人研修効率化（3ヶ月→1ヶ月）や複雑業務の導入成功を実現。2024年2月の退職後、世界標準のフロントエンド学習プラットフォーム「The Odin Project」等により1年半でフロントエンド開発の実用レベルを習得。現在、オンライン英会話・留学・外資での豊富な国際経験と新たに習得した技術力を融合し、グローバルなフロントエンド開発に従事したく考えている。
        </SectionContent>
        ...
        <CompanyBlock>
          ...
          <JobContent>
            ...
            HTML/CSS基礎 → JavaScript(ES6+) → React.js → Next.js → TypeScript（習得中）の順で体系的スキルアップ。特にポートフォリオサイト制作には半年を要し、多数のエラーと技術的課題に直面するも、現代のUI/UXデザインとユーザーが求める要素を学習しつつ、完成後も5度の大幅なレイアウト修正を実行し、納得のいく形まで開発を追求。Shadcn UI等のライブラリカスタマイズ、HackerRankでのアルゴリズム問題演習、Vanilla JS・DOM操作・API連携等も並行実施。
          </JobContent>
      ...
      <Page className="page">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{fontSize: '7.5pt', padding: '2mm', lineHeight: '1.1'}}>
                ...
                ・オンライン英会話 10年以上継続・3,000回以上・90,000分以上・Legendランク達成<br/>
        ...
        <PRSection>
          <SubSectionTitle style={{fontSize: '10pt'}}>継続学習力と国際適応力</SubSectionTitle>
          <PRContent style={{fontSize: '9.5pt'}}>
            35歳から本格的にフロントエンド開発に挑戦し、1年半にわたり毎日6-14時間の学習を継続。法学部で培った論理思考により、多数の技術的課題を段階的に解決し実用レベルに到達。10年以上のオンライン英会話継続とデンマーク留学・フィリピン居住経験により、どこでも適応できる国際感覚を習得済み。
          </PRContent>
        </PRSection>

        <PRSection>
          <SubSectionTitle style={{fontSize: '10pt'}}>現地開拓力と文化的橋渡し能力</SubSectionTitle>
          <PRContent style={{fontSize: '9.5pt'}}>
            アクセンチュア・フィリピンでは現地第一号として独自に適応ノウハウを開拓し、後続日本人スタッフの定着率向上に貢献。日本人-フィリピン人間の文化的違いを理解し、両者の架け橋として機能。マニュアルにない課題への自律的対応が評価され、最終半年間は実質的なサブチームリーダーとして5名チームを統括。
          </PRContent>
        </PRSection>

        <SectionTitle style={{fontSize: '11pt', margin: '8mm 0 4mm 0'}}>■ 志望動機</SectionTitle>
        <SectionContent style={{fontSize: '9.5pt'}}>
          フィリピンでのフロントエンド開発ポジションとして、長年のオンライン英会話経験、現地での国際的な業務経験、そして新たに習得したフロントエンド技術を活かし、貢献したく応募いたします。10年以上のオンライン英会話継続（3,000回以上・90,000分以上・Legendランク達成）とフィリピン3年居住経験を通じて、語学学習の困難さと達成感を身をもって体験してきました。
          <br/><br/>
          これらの経験と新たに習得したフロントエンド技術を融合し、世界中の学習者にとってより直感的で使いやすい学習プラットフォームの開発に貢献したいと考えています。特に、ヘビーユーザーとしての深い理解と、日本とフィリピンの架け橋としての経験を活かし、現地チームとの連携強化に貢献できると確信しています。
          <br/><br/>
          フィリピン現地での3年間の実体験により、多くの日本人が直面する現地適応問題（気候・食事・生活習慣・コミュニケーション・健康管理等）への耐性が備わっています。プロジェクトを継続的に支えるために重要な現地への免疫体制を備えており、安定したチーム運営と継続的な成果創出が可能となります。
        </SectionContent>
