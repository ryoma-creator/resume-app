            ...
            <tbody>
              <tr>
                <td colSpan="3" style={{height: '80mm', padding: '4mm', lineHeight: '1.3', fontSize: '9pt'}}>
                  ...
                  NativeCampの「言語の壁を越えたコミュニケーション」というビジョンに強く共感し、フロントエンド開発者として貢献したく応募いたします。<br/><br/>

                  <strong>アピールポイント</strong><br/>
                  ・1年半の集中学習（毎日6-14時間）により習得したフロントエンド技術一式（React/Next.js、TypeScript、アニメーション実装、レスポンシブデザイン、Git管理等）<br/>
                  ・技術的課題への取り組み経験（リポジトリ復旧、メディア最適化等）<br/>
                  ・アクセンチュア・フィリピンでサブチームリード経験（5名のチーム管理）<br/>
                  ・日本人-フィリピン人間の調整により多国籍チーム連携をスムーズ化<br/>
                  ・新人研修期間を約70%短縮（3ヶ月→1ヶ月）する効率化手法を確立<br/>
                  ・フィリピン現地での生活・健康管理ノウハウ習得済み（駐在員特有の課題を解決済み）<br/>
                  ・法学部での論理思考力を基盤とした本質的な問題解決能力<br/>
                  ・10年以上の英語学習継続による高いコミュニケーション能力<br/>
                  ・15年以上のサッカー・フットサル経験によるチームワークとリーダーシップ<br/><br/>

                  特に、多様な文化背景を持つユーザーにとって使いやすいインターフェースの開発と、日本とフィリピンの架け橋としての役割を果たせると確信しています。技術力の向上と既存のIT・英語スキルの融合により、貴社の国際的な成長に貢献したいと考えています。
                </td>
              </tr>
            </tbody>
          </MotivationTable>
            ...
            <tbody>
              <tr>
                <td colSpan="3" style={{height: '40mm', padding: '4mm', lineHeight: '1.3', fontSize: '9pt'}}>
                  ...
                  ・<strong>勤務地</strong>：セブ移転可能（移転サポートについてご相談させてください）<br/>
                  ・<strong>その他</strong>：フィリピン現地の生活・健康管理ノウハウを活かし、日本人スタッフの現地適応サポートとチーム統合に貢献したい。IT・英語スキルを融合した国際環境で更なる成長を目指す<br/><br/>

                  貴社のセブオフィスでの勤務を強く希望しており、必要に応じて速やかな移転が可能です。
                </td>
              </tr>
            </tbody>
          </RequestTable>
